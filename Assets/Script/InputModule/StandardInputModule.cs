...
namespace Script.InputModule
{
    ...
    /// </remarks>
    public class StandardInputModule : PointerInputModuleCustom
    {
        ...
        private bool ProcessTouchEvents()
        {
            for (int i = 0; i < input.touchCount; ++i)
            {
                ...
                // Debug.Log(pointer.pointerCurrentRaycast.gameObject.name);
        ...
        protected void ProcessMouseEvent(int id)
        {
            ...
            // Debug.Log(leftButtonData.buttonData.pointerCurrentRaycast.gameObject.name);
